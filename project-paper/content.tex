...
That is why the REST Abstract File System comes into picture. It
...
\TODO{YOU USE LATEX PARAGRAPHS WRONG}

\paragraph{Steps to create new root account with AWS}

\TODO{TEXT MISING}
\TODO{NO URLS IN TEXT THEY MUST BE CITATIONS}
...
\TODO{INCONSITANT USE OF PARAGRAPHS}
