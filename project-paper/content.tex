...
\title{REST Abstract File System}
...
\begin{abstract}
  ...
  file operations like, retrieving, storing, removing etc. The
  services are provided to support storage engines such as Amazon
  Simple Storage Service, google drive and virtual machine. This web
  service package can be used by different big data applications
  client to perform file operations with consolidated data view.
\end{abstract}
...
That is why the REST Abstract File System Service comes into picture. It
...
The REST Abstract File System Service facilitates integration with any virtual machine
...
the REST Abstract File System Service and then using swagger-codegen to generate code using 
...
REST Abstract File System Service with Amazon S3 as an underlying storage engines. 
...
To check all file operations supported by the REST Abstract File System Service to integrate 
...
To check all file operations supported by the REST Abstract File System Service 
