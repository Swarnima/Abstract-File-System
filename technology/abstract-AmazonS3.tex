...
store virtually any kind of data in any format.
...
data~\cite{hid-sp18-420-amazon-S3}. As per Amazon documentation, It is designed
to deliver 99.999999999\% durability, and stores data for millions of
applications used by market leaders in every
